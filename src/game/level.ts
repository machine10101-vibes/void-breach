...
function buildEmberRail(): LevelDef {
  ...
  add(
    box(-13.6, -118.0, 8.2, 12.0, 7.6),
    box(-14.0, -129.0, 8.6, 11.4, 7.0),
    box(13.6, -118.4, 8.2, 12.2, 7.4),
    box(14.0, -129.4, 8.6, 11.6, 8.0),
    box(-5.4, -118, 2.4, 0.8, 0.9, 0, true, "cover"),
    box(5.4, -122, 2.4, 0.8, 0.9, 0, true, "cover"),
    box(0, -124, 3.2, 1.2, 1.0, 0, true, "car"),
    box(-4.4, -128, 1.5, 1.5, 1.3, 0, true, "crate"),
    box(4.6, -128, 1.5, 1.5, 1.3, 0, true, "crate"),
    box(0, -140, 44, 6, 8),
  );
    ...
    spawners: [
      ...
      },
      {
        ...
        enemies: [
          ...
          { kind: "husk", x: -2, z: -32 },
          { kind: "wraith", x: -4, z: -26 },
          { kind: "spitter", x: 0, z: -30 },
        ],
      },
      {
        id: "cut",
        zTrigger: -28,
        message: "Service cut — mixed pack",
        enemies: [
          { kind: "brute", x: 0, z: -36 },
          { kind: "spitter", x: -4, z: -34 },
          { kind: "spitter", x: 4, z: -38 },
          { kind: "wraith", x: -2, z: -40 },
          { kind: "husk", x: 2, z: -33 },
          { kind: "husk", x: -3, z: -41 },
        ],
      },
      {
        ...
        enemies: [
          ...
          { kind: "wraith", x: 3, z: -62 },
          { kind: "spitter", x: 0, z: -54 },
        ],
      },
      {
        id: "yard",
        zTrigger: -68,
        message: "Ash yard — heavies inbound",
        enemies: [
          { kind: "brute", x: -3, z: -78 },
          { kind: "brute", x: 3, z: -82 },
          { kind: "spitter", x: 0, z: -76 },
          { kind: "wraith", x: -4, z: -84 },
          { kind: "wraith", x: 4, z: -80 },
          { kind: "husk", x: -2, z: -86 },
          { kind: "husk", x: 2, z: -74 },
        ],
      },
      {
        ...
        enemies: [
          { kind: "harbinger", x: 0, z: -124 },
          { kind: "spitter", x: -5, z: -118 },
          { kind: "spitter", x: 5, z: -118 },
          { kind: "wraith", x: -3, z: -128 },
          { kind: "wraith", x: 3, z: -128 },
          { kind: "brute", x: 0, z: -116 },
          { kind: "spitter", x: 0, z: -130 },
        ],
      },
    ],
    lamps: [
...
function buildNullSpire(): LevelDef {
  ...
  add(
    box(-14.0, -120.5, 8.4, 12.4, 9.0),
    box(-14.4, -132.0, 8.8, 12.0, 8.4),
    box(14.0, -121.0, 8.4, 12.6, 8.8),
    box(14.4, -132.4, 8.8, 12.2, 9.4),
    box(-6.2, -120, 2.6, 0.8, 0.9, 0, true, "cover"),
    box(6.2, -124, 2.6, 0.8, 0.9, 0, true, "cover"),
    box(-4.8, -128, 1.2, 1.2, 5.0, 0, false, "pillar"),
    box(4.8, -128, 1.2, 1.2, 5.0, 0, false, "pillar"),
    box(-5.2, -144, 2.4, 0.8, 0.9, 0, true, "cover"),
    box(5.2, -146, 2.4, 0.8, 0.9, 0, true, "cover"),
    box(-13.8, -144.0, 8.2, 12.0, 8.8),
    box(13.8, -144.4, 8.2, 12.2, 9.0),
    box(0, -162, 50, 6, 9),
  );
    ...
    spawners: [
      ...
      },
      {
        ...
        enemies: [
          ...
          { kind: "brute", x: 0, z: -34 },
          { kind: "husk", x: -2, z: -30 },
          { kind: "wraith", x: 4, z: -22 },
          { kind: "spitter", x: -4, z: -32 },
        ],
      },
      {
        id: "annex",
        zTrigger: -28,
        message: "Annex — blink pack",
        enemies: [
          { kind: "wraith", x: -4, z: -38 },
          { kind: "wraith", x: 4, z: -40 },
          { kind: "wraith", x: 0, z: -42 },
          { kind: "spitter", x: -2, z: -36 },
          { kind: "spitter", x: 3, z: -44 },
          { kind: "brute", x: 0, z: -46 },
          { kind: "husk", x: -3, z: -41 },
        ],
      },
      {
        ...
        enemies: [
          ...
          { kind: "spitter", x: 3, z: -62 },
          { kind: "wraith", x: -5, z: -56 },
          { kind: "wraith", x: 5, z: -60 },
          { kind: "husk", x: 0, z: -64 },
        ],
      },
      {
        id: "stack",
        zTrigger: -68,
        message: "Relay stack — no cover",
        enemies: [
          { kind: "brute", x: 0, z: -78 },
          { kind: "brute", x: -4, z: -82 },
          { kind: "spitter", x: 4, z: -76 },
          { kind: "spitter", x: -2, z: -84 },
          { kind: "wraith", x: 3, z: -80 },
          { kind: "wraith", x: -3, z: -74 },
          { kind: "wraith", x: 0, z: -86 },
          { kind: "husk", x: 2, z: -72 },
        ],
      },
      {
        id: "nave",
        zTrigger: -96,
        message: "Nave — last halls",
        enemies: [
          { kind: "brute", x: -3, z: -106 },
          { kind: "brute", x: 3, z: -110 },
          { kind: "wraith", x: -5, z: -104 },
          { kind: "wraith", x: 5, z: -108 },
          { kind: "spitter", x: 0, z: -102 },
          { kind: "spitter", x: -2, z: -114 },
          { kind: "wraith", x: 2, z: -112 },
          { kind: "husk", x: 0, z: -116 },
        ],
      },
      {
        ...
        enemies: [
          { kind: "harbinger", x: 0, z: -148 },
          { kind: "wraith", x: -6, z: -142 },
          { kind: "wraith", x: 6, z: -142 },
          { kind: "spitter", x: -4, z: -152 },
          { kind: "spitter", x: 4, z: -152 },
          { kind: "brute", x: 0, z: -140 },
          { kind: "wraith", x: -3, z: -154 },
          { kind: "wraith", x: 3, z: -154 },
        ],
      },
    ],
